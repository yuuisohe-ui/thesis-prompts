...
> **본 파일은 논문 부록 「프롬프트 재현 자료(Prompt Reproduction Appendix)」 전체 51개 파일(본 템플릿 1 · README 1 · 공용 P 계열 27 · 교사 T 계열 13 · 학생 S 계열 5 · 백엔드 B 계열 4)가 공통으로 따르는 골격을 정의한다.** 본 템플릿은 Lovable 플랫폼 상에서 가장 안정적으로 해석·실행되는 구조를 채택하며, 그 이론적 근거는 아래 네 건의 일차 자료에 기반한다.
