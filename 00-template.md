...
> **본 파일은 논문 부록 「프롬프트 재현 자료(Prompt Reproduction Appendix)」 전체 18개 문서(P1–P8, T1–T6, S1–S4, L1)가 공통으로 따르는 골격을 정의한다.** 본 템플릿은 Lovable 플랫폼 상에서 가장 안정적으로 해석·실행되는 구조를 채택하며, 그 이론적 근거는 아래 네 건의 일차 자료에 기반한다.
