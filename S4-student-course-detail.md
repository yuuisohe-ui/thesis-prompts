...
> 초대 링크 진입·학생 프로필 온보딩·`course_members` upsert 은 **S2**, 온보딩 이후 진입하는 학생 대시보드(내 공간)는 **S1(=`/student-home`)** 담당. S4 는 "학생이 반 안에 들어와서 하는 모든 것".
...
- **S1 (학생 내 공간)**: `/student-home` 캘린더·알림 요약 카드 등. 실제 반 내부 상호작용은 S4 로 위임.
